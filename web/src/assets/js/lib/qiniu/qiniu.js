...
function QiniuJsSDK() {
    ...
    this.uploader = function(op) {
        ...
        var reset_chunk_size = function() {
            ...
            // case Safari 5ã€Windows 7ã€iOS 7 set isSpecialSafari to true
            ...
            // case IE 9-ï¼Œchunk_size is not empty and flash is included in runtimes
                ...
                if (file) {
                    switch (err.code) {
                        case plupload.FAILED:
                            errTip = 'ä¸Šä¼ å¤±è´¥ã€‚è¯·ç¨åŽå†è¯•ã€‚';
                            break;
                        case plupload.FILE_SIZE_ERROR:
                            var max_file_size = up.getOption && up.getOption('max_file_size');
                            max_file_size = max_file_size || (up.settings && up.settings.max_file_size);
                            errTip = 'æµè§ˆå™¨æœ€å¤§å¯ä¸Šä¼ ' + max_file_size + 'ã€‚æ›´å¤§æ–‡ä»¶è¯·ä½¿ç”¨å‘½ä»¤è¡Œå·¥å…·ã€‚';
                            break;
                        case plupload.FILE_EXTENSION_ERROR:
                            errTip = 'æ–‡ä»¶éªŒè¯å¤±è´¥ã€‚è¯·ç¨åŽé‡è¯•ã€‚';
                            break;
                        case plupload.HTTP_ERROR:
                            if (err.response === '') {
                                // Fix parseJSON error ,when http error is like net::ERR_ADDRESS_UNREACHABLE
                                errTip = err.message || 'æœªçŸ¥ç½‘ç»œé”™è¯¯ã€‚';
                            ...
                            switch (err.status) {
                                case 400:
                                    errTip = "è¯·æ±‚æŠ¥æ–‡æ ¼å¼é”™è¯¯ã€‚";
                                    break;
                                case 401:
                                    errTip = "å®¢æˆ·ç«¯è®¤è¯æŽˆæƒå¤±è´¥ã€‚è¯·é‡è¯•æˆ–æäº¤åé¦ˆã€‚";
                                    break;
                                case 405:
                                    errTip = "å®¢æˆ·ç«¯è¯·æ±‚é”™è¯¯ã€‚è¯·é‡è¯•æˆ–æäº¤åé¦ˆã€‚";
                                    break;
                                case 579:
                                    errTip = "èµ„æºä¸Šä¼ æˆåŠŸï¼Œä½†å›žè°ƒå¤±è´¥ã€‚";
                                    break;
                                case 599:
                                    errTip = "ç½‘ç»œè¿žæŽ¥å¼‚å¸¸ã€‚è¯·é‡è¯•æˆ–æäº¤åé¦ˆã€‚";
                                    if (!unknow_error_retry(file)) {
                                        return;
                                    }
                                    break;
                                case 614:
                                    ...
                                    break;
                                case 631:
                                    errTip = "æŒ‡å®šç©ºé—´ä¸å­˜åœ¨ã€‚";
                                    break;
                                case 701:
                                    errTip = "ä¸Šä¼ æ•°æ®å—æ ¡éªŒå‡ºé”™ã€‚è¯·é‡è¯•æˆ–æäº¤åé¦ˆã€‚";
                                    break;
                                default:
                                    errTip = "æœªçŸ¥é”™è¯¯ã€‚";
                                    if (!unknow_error_retry(file)) {
                            ...
                            errTip = errTip + '(' + err.status + 'ï¼š' + errorText + ')';
                            break;
                        case plupload.SECURITY_ERROR:
                            errTip = 'å®‰å…¨é…ç½®é”™è¯¯ã€‚è¯·è”ç³»ç½‘ç«™ç®¡ç†å‘˜ã€‚';
                            break;
                        ...
                        case plupload.INIT_ERROR:
                            errTip = 'ç½‘ç«™é…ç½®é”™è¯¯ã€‚è¯·è”ç³»ç½‘ç«™ç®¡ç†å‘˜ã€‚';
                            uploader.destroy();
                            break;
                        default:
